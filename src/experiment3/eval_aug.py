...
MODEL_PATH = os.path.join(os.path.dirname(__file__), "models", "base_cnn_augmented.pth")

from src.data_processing.process_data import BATCH_SIZE, preprocess_data
from src.analysis.eval_helpers import *
from src.experiment3.aug_cnn import BaseGarbageCNN
...
print_metrics("Exp 3 (Aug)", MODEL_PATH, metrics)
